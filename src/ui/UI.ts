...
export class UI {
  ...
  constructor(root: HTMLElement) {
    root.innerHTML = `<div class="vignette"></div><div class="grain"></div><div class="frame-top"><a class="brand" href="#" aria-label="Last Metro title">${logo}<span>LAST METRO</span></a><span class="build-tag">ESCAPE LOOP ALPHA <i>v0.2</i></span></div><div id="overlay"></div><div id="hud" hidden><div class="objective-block"><span class="eyebrow">CURRENT OBJECTIVE</span><p id="objective"></p></div><div class="location-block"><span class="signal-dot"></span><span id="location">PLATFORM 09</span><small>ANTIM NAGAR · NIGHT LINE</small></div><div class="departure-clock"><span class="eyebrow">DEPARTURE WINDOW</span><strong id="countdown">18:00</strong><small id="clock-status">ORIENTATION</small></div><div class="crosshair"></div><div id="interaction"></div><div id="sound-caption" role="status" aria-live="polite"></div><div class="hud-bottom"><span><kbd>W A S D</kbd> MOVE <kbd>E</kbd> INTERACT <kbd>TAB</kbd> JOURNAL</span><span id="stance">STANDING · LIGHT ON</span><button data-action="pause" class="quiet-button">ESC &nbsp; PAUSE</button></div></div><div id="subtitle" role="status" aria-live="polite"></div><div id="toast" role="status" aria-live="polite"></div>`;
