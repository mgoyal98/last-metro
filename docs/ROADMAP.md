...
| 4 — Polish and accessibility | Materials/assets, staged hints, loading, audio mix, accessibility review and balance (volume/caption/motion controls already implemented) | Clues readable; all critical sounds captioned; asset licences recorded; settings persist | In development; see MILESTONE-04.md |
