...
| 2 — Complete escape loop | Three connected puzzles, retained notes, local checkpoint migration, generous countdown, two evidence-based endings | Both endings reachable; all wrong puzzle inputs recoverable; menus suspend timers | In development; see MILESTONE-02.md |
