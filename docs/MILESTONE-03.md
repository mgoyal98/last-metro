...
Status: complete locally — `v0.3.0-alpha`. Baseline: `v0.2.0-alpha`.
...
See `docs/QA.md` for test evidence, initial/focused run boundaries, the wall-edge pursuit correction, screenshots and remaining production gates.
